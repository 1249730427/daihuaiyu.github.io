...
public class ChatFrame extends JFrame{
    ...
    public void init(){
        ...
        sendButton.addActionListener(e -> {
            ...
            String message = NettyClientHandler.Nickname+"   " +sf.format(new Date())+"\n"+msg;
            //暂存显示面板之中的消息
            sb.append(message+"\n");
            //显示面板读取消息
        ...
        //设置背景
        backGround = new ImageIcon("D:\\Study\\imageSource\\1.jpg");
        label = new JLabel();
        ...
        icon = new ImageIcon("D:\\Study\\imageSource\\3.png");
